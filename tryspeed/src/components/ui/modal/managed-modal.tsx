...
const ServerChangeView = dynamic(() => import('@framework/changeserver/changeserver-form'));
...
// const RefundRequestView = dynamic(
//     () => import('@framework/refunds/refund-request-view')
// );
...
const ManagedModal = () => {
    ...
    return (
        <Modal open={isOpen} onClose={closeModal}>
            ...
            {view === 'CHANGE_SERVER' && <ServerChangeView/>}
            {view === 'REGISTER' && <Register/>}
            {view === 'FORGOT_VIEW' && <ForgotPassword/>}
            {view === 'OTP_LOGIN' && <OtpLoginView/>}
            {view === 'REFUND_REQUEST' && <RefundRequestView/>}
