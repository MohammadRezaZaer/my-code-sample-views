...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  return (
    <div className="py-6 px-5 sm:p-8 bg-[#1D1B45] w-screen md:max-w-[480px] min-h-screen md:min-h-0 h-full md:h-auto flex flex-col justify-center md:rounded-xl">
      ...
      <Form<FormValues> onSubmit={onSubmit} validationSchema={loginFormSchema} autoComplete="off">
